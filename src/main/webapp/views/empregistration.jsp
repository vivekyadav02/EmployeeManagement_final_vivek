...
<body>
	...
	<div class="col-md-10" style="padding-left: 300px; width: 800px;">
		<form:form style="text-align: center; width: 700px;" action="empdetails" method="post" modelAttribute="emp">
			<div class="form-group row">
				<label for="inputEmail3" class="col-sm-4 col-form-label">Employee
					Code</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="inputEmail3" name="empId" required>
				</div>
			</div>
			<br>
		...
		<br>
			<div class="form-group row">
				<label for="inputPassword3" class="col-sm-4 col-form-label">Employee
					Name</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="inputPassword3" name="empName"
						required>
				</div>
			</div>
			<br>
		...
		<br>
			<div class="form-group row">
				<label for="inputPassword3" class="col-sm-4 col-form-label">Birth
					of Date</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="inputPassword3" name="dob"
						required>
				</div>
			</div>
			<br>
